...
public class Trader_Hub extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Tab tradesTab = actionBar.newTab();
		tradesTab.setText("Trades");
		tradesTab.setTabListener(this);
		actionBar.addTab(tradesTab);
...
public class Trader_Hub extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_trader__hub);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.trader__hub, menu);
		return true;
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.fragment_trader__hub,
					container, false);
			return rootView;
		}
	}
...
>>>>>>> 7a7ac2ae8261939fcafa1412cd03dcb8c2c8f79b
